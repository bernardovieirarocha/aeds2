package tps.tp3.ex10_ListaDuplamenteEncadeada;
...
class ListaDuplamenteEncadeada {
    ...
    public Pokemon remover() {
        ...
        Celula tmp = ultimo;
        ultimo = ultimo.ant;
        Pokemon resp = ultimo.prox.elemento;
        tmp = null;
        return resp;
    }
    ...
    public void mostrarReverse(Celula i, int n) {
        if (i != null) {
            mostrarReverse(i.ant, n - 1);
            System.out.println("(" + n + ") " + i.elemento.getName());
        }
    }
...
public class ex10_ListaDuplamenteEncadeada {
    public static void main(String[] args) {
        List<Pokemon> pokemons = ReadCSV.readCSV("/tmp/pokemon.csv");
        ListaDuplamenteEncadeada filaPoke = new ListaDuplamenteEncadeada();
        ...
        PokemonOrdenacao.quickSort(filaPoke);

        MyLog.endTimer();

        filaPoke.mostrar();

        MyLog.createLog("853733", "quicksort3");
...
class PokemonOrdenacao {

    public static void quickSort(ListaDuplamenteEncadeada lista) {
        if (lista.getTopo() != null && lista.getTopo() != lista.primeiro) {
            quickSortRecursive(lista, lista.primeiro.prox, lista.getTopo());
        }
    }
