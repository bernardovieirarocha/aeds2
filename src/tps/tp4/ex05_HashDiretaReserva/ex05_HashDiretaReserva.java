package tps.tp4.ex05_HashDiretaReserva;
...
class TabelaHashReserva {
    ...
    // Funcao Hash ( (ASCII name) mod tamTab onde tamTa )
    ...
    public boolean inserir(String pokemonNome) {
        ...
        if (pokemonNome != null) {
            ...
            if (this.tabela[pos] == null) {
                ...
                tabela[this.tamanhoNormal + this.reserva] = pokemonNome;
                this.reserva++;
                resp = true;
            }
        }
    ...
    public void pesquisar(String nome) {
        ...
        if (tabela[pos].equals(nome)) {
            ...
            for (int i = 0; i < this.reserva; i++) {
                if (tabela[this.tamanhoNormal + i].equals(nome)) {
                    MyLog.countComp(1);
                    resp = true;
                    imprimirResultado(nome, this.tamanhoNormal + i, resp);
                    i = reserva; // break
                    return;
                }
            }
...
public class ex05_HashDiretaReserva {
    public static void main(String[] args) {
        ...
        MyLog.createLog("853733", "hashReserva");
