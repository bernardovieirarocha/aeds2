package tps.tp2.ex05_OrdenacaoSelecao;
...
public class ex05_OrdenacaoSelecao {
    public static void main(String[] args) {
        ...
        PokemonSearch.ordenarSelecaoPorNome(pokedex);
...
class PokemonSearch {
    ...
    public static void ordenarSelecaoPorNome(List<Pokemon> pokedex) {
